...
und pdf_path im Vault gespeichert. Zitiert wird ausschliesslich lokal via
vault.add_quote(extraction_method="local-verbatim") — das ist nur moeglich,
wenn pdf_path noch verfuegbar ist. Einen PDF-Upload-Cache bei Anthropic gibt
es seit #632 nicht mehr: keine Plugin-Funktion setzt einen eigenen Modellzugang
ausserhalb der Sitzung voraus.
...
from academic_vault.server import add_paper, add_quote  # noqa: E402
