...
def test_export_snapshot_returns_bytes(tmp_path, temp_vault_db):
...
def test_export_snapshot_creates_tgz_file(tmp_path, temp_vault_db):
...
def test_export_snapshot_tarball_contains_state_files(tmp_path, temp_vault_db):
...
def test_export_snapshot_ts_in_filename(tmp_path, temp_vault_db):
...
def test_export_snapshot_failopen_when_dir_missing(tmp_path, temp_vault_db):
