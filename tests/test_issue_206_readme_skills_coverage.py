...
def test_skills_badge_count_is_29():
    text = README.read_text(encoding="utf-8")
    assert re.search(r"img\.shields\.io/badge/skills-29", text), (
        "Skills-Badge muss auf 'skills-29' stehen (29 SKILL.md inkl. xlsx-Vendor)."
    )
