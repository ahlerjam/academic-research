...
def test_skills_badge_count_is_42():
    text = README.read_text(encoding="utf-8")
    assert re.search(r"img\.shields\.io/badge/skills-42", text), (
        "Skills-Badge muss auf 'skills-42' stehen (42 SKILL.md, Stand Issue #391)."
    )
