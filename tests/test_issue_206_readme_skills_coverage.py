...
def test_skills_badge_count_is_33():
    text = README.read_text(encoding="utf-8")
    assert re.search(r"img\.shields\.io/badge/skills-33", text), (
        "Skills-Badge muss auf 'skills-33' stehen (33 SKILL.md, Stand Issue #447)."
    )
