...
def test_skills_badge_count_is_35():
    text = README.read_text(encoding="utf-8")
    assert re.search(r"img\.shields\.io/badge/skills-35", text), (
        "Skills-Badge muss auf 'skills-35' stehen (35 SKILL.md, Stand Issue #447)."
    )
