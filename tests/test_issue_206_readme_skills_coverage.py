...
def test_skills_badge_count_is_40():
    text = README.read_text(encoding="utf-8")
    assert re.search(r"img\.shields\.io/badge/skills-40", text), (
        "Skills-Badge muss auf 'skills-40' stehen (40 SKILL.md, Stand Issue #605)."
    )
