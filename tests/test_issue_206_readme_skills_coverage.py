...
def test_skills_badge_count_is_31():
    text = README.read_text(encoding="utf-8")
    assert re.search(r"img\.shields\.io/badge/skills-31", text), (
        "Skills-Badge muss auf 'skills-31' stehen (31 SKILL.md, Stand Issue #446)."
    )
