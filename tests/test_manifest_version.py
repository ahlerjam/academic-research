...
def test_plugin_json_description_mentions_current_skill_count():
    """plugin.json description soll die aktuelle Skill-Zahl (34, Issue #446) nennen."""
    data = json.loads(PLUGIN_JSON.read_text())
    description = data["description"]
    assert "34" in description, f"plugin.json description enthält nicht '34': '{description}'"
