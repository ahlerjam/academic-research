...
| [`2026-08-09-chunk-fusion-goldset-790.md`](2026-08-09-chunk-fusion-goldset-790.md) | Gezielt konstruiertes Probe-Goldset (21 Paper / 71 Chunks / 38 Queries), das den Nullbefund aus #729 auflöst: Signal-Split als dominanter Mechanismus belegt, Gewinn- und Schadensrichtung betragsgleich (±0,3691 nDCG@10), Crowding als messbar zu schwach ausgewiesen, Kontrollen bei exakt 0 — Vorbedingungen maschinell geprüft statt zugesichert; Betriebshäufigkeit ausdrücklich offen (#790, Epic #711) |
