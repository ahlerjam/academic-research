...
> **Historisches Dokument.** Momentaufnahme zu v6.2, nicht der aktuelle Stand. Der
> hier urspruenglich beschriebene „Eval-Lauf" war ein reiner YAML-Dump ohne jede
> Pruefung — `sources.yaml` wurde von keinem Code gelesen (Befund aus #390). Den
...
Der ausfuehrbare Teil laeuft seit #390 hermetisch ueber einen Runner:
