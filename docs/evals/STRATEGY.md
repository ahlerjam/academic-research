...
| `free-archive-fetchers` | structural | `tests/test_free_archive_fetchers.py` (Schema-Assertions) | Cases erwarten Live-Downloads von HathiTrust/Internet Archive/MDZ; jeder Lauf waere netzabhaengig und wuerde CI bei fremden Ausfaellen rot faerben (gleiche Lage wie `oa-fetchers`). |
