...
```mermaid
graph TD
    U[Du in Claude Code] --> CMD[11 Slash-Commands]
    U --> SK[45 Skills<br/>selbstaktivierend]
    CMD --> AG[28 Agents / Subagents]
    SK --> AG
...
28 Agents und 45 Skills einzeln benannt, das Zusammenspiel der 15 Suchquellen im Detail
