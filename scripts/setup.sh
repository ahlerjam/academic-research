...
# ---------------------------------------------------------------------------
# 8 der 10 Hooks sind '.mjs'-Dateien und werden in hooks/hooks.json per
...
if ! command -v node &>/dev/null; then
  echo "⚠️  Node.js nicht gefunden — 8 der 10 Hooks (u. a. verbatim-guard, claim-drift-guard, context-fidelity-guard) laufen NICHT."
